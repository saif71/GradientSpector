  ...
  array (
    ...
    array (
      ...
      array (
        ...
        232 =>
        array (
          'name' => 'can_you feel_the_love_tonight',
          'colors' =>
          array (
            0 => '#4568dc',
            1 => '#b06ab3',
...
for (i = 0; i < 400; i++) {
  document.write("\."+unit[i].name);
  document.write(" <br> { <br>");
  document.write("background:"+unit[i].colors[0]+"; /* fallback_for old browsers */ <br>");
  document.write("background: -webkit-linear-gradient(to right, " +unit[i].colors[0]+ "," +unit[i].colors[1] +"); /* Chrome_10-25, Safari 5.1-6 */ <br>");
  document.write("background: linear-gradient(to right, " +unit[i].colors[0]+ "," +unit[i].colors[1] +"); /* W3C, Ie_10+/ Edge, Firefox 16+, Chrome_26+, Opera 12+, Safari 7+ */ <br>");
  document.write("}");
  document.write(" <br> <br>");
}
</script>
